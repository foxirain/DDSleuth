...
class EventKind(StrEnum):
    ...
    TRANSPORT_DATAGRAM_CAPTURED = "transport.datagram_captured"
    ...
    APPLICATION_OBSERVATION_WINDOW = "application.observation_window"
    MEMORY_SAFETY_VIOLATION = "memory_safety.violation"
